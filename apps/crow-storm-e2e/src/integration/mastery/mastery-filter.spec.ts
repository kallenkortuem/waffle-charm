...
describe('mastery level filter', () => {
  ...
  it('should disable the the button if there is only one selected', () => {
    ...
    getMasteryLevelFilter(7).should('have.attr', 'aria-pressed', 'false')
    getMasteryLevelFilter(6).click().blur()
    getMasteryLevelFilter(6).should('have.attr', 'aria-pressed', 'false')
    getMasteryLevelFilter(5).click().blur()
    getMasteryLevelFilter(5).should('have.attr', 'aria-pressed', 'false')
    getMasteryLevelFilter(4).click().blur()
    getMasteryLevelFilter(4).should('have.attr', 'aria-pressed', 'false')
    getMasteryLevelFilter(3).click().blur()
    getMasteryLevelFilter(3).should('have.attr', 'aria-pressed', 'false')
    getMasteryLevelFilter(2).click().blur()
    getMasteryLevelFilter(2).should('have.attr', 'aria-pressed', 'false')
